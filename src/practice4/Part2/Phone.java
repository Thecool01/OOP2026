...
public class Phone implements Pluggable {
    private String name;
    private int ageOfProduction;
    private String model;
    public Phone(String name, int ageOfProduction, String model) {
        this.name = name;
    ...
    @Override
    public void plugIn() {
        System.out.println("Phone " + this.getName() + " " + getModel() + " is plugged in.");
    }
